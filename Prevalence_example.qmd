---
title: "Height Prevalence Example"
author: "Brian Holt"
format: 
  revealjs:
    theme: simple
...
* Incidence = (New Cases) / (Population x Timeframe)  
  ...
  Tenny, S., & Boktor, S. W. (2025). Incidence. In StatPearls. StatPearls Publishing. http://www.ncbi.nlm.nih.gov/books/NBK430746/
...
* Prevalence: Total number of people with the disease divided by total number of people
    ...
    * Lifetime--total number of people that at some point in their life meet criteria divided of total 
number of people
...
Note that there is 2.54 cm per inch, so 165 cm is equliavlent to `{r} 165/2.54` inches, or just under 5 foot 5. Two hundred cm is `{r} 200/2.54` inches, or 6 foot 6. 

# Prevalence estimate: taller than 185 cm

So, 185 cm is `{r} 185/2.54`, just under 6 feet and 1 inch.  This code below takes the sample and compares it's rate of people taller than 185 cm and then compares that to the actual population.  yes...this is all silly but's close to how things work.  
