---
title: "General Psychology Schedule Winter  2026"
author: "Brian Holt"
date: "`r Sys.Date()`"
output: 
  html_document:
   ...
   config:
      toc:
        ...
        before: |
          <li><a href="./">General Psychology Winter 2026 schedule</a></li>`
        after: |
...
# Background before we begin
  ...
  F. Computer requirements: 
   ...
   1. You must have access to a real computer for writing. If you cannot afford a laptop or do not have a laptop or computer please contact me. 
...
G. Software (apps)
  ...
  2. A free Google doc account that you have administrative power.  This can't be "owned" by a parent or a highschool. If you set your own Gmail account up, you already have a Google account for documents and spreadsheets. **This is a requirement; no other word processing software will be allowed.** Reasons are listed in the syllabus

 
# Week 1 January 5 {#Week1} 



## Summary of what really needs to get done before Monday


### Read
1. [The 9 standards of Critical thinking (in the syllabus)](https://docs.google.com/document/d/1Jwo68U8f3gWTWgu_EuTNyGQD2KQeQROsqP_BauADs1g/edit#heading=h.j2nlxy74qee8){target=”_blank”}
...
3. Read @Schwartz1771, [The importance of stupidity in scientific research](https://jcs.biologists.org/content/121/11/1771){target='_blank'}

4. Read [This evaluation](https://docs.google.com/document/d/1-g6-uJELM5zgb-yTRCQ8Ah76P9FccFZ_V2GK6YwP3iw/edit?usp=sharing){target='_blank'}

### Do

1. Write a synthesis of the 4 sources above (1. the critical thinking standards, 2. stupidity in science, 3. red scare evaluation--the evaluation, not your thoughts, and then 4. chapter 2).  You may want to consider a comment about whether you think knowledge is static.
...
1. [The syllabus](https://docs.google.com/document/d/1Dl6kwktH53wSnPS-CEP2yadHCNgmaUL1PD-8v9fm6x8/edit?usp=sharing){target=”_blank”}

2. [Miller's law of communication (in the syllabus)](https://docs.google.com/document/d/1Dl6kwktH53wSnPS-CEP2yadHCNgmaUL1PD-8v9fm6x8/edit?tab=t.0#bookmark=kix.7tzsfvmjef7d){target=”_blank”}

3. [George Orwell, Politics and the English Language, 1946 (in the syllabus)](https://docs.google.com/document/d/1Dl6kwktH53wSnPS-CEP2yadHCNgmaUL1PD-8v9fm6x8/edit?tab=t.0#bookmark=id.uldghwit0e45){target=”_blank”}

4. [The 9 standards of Critical thinking (in the syllabus)](https://docs.google.com/document/d/1Dl6kwktH53wSnPS-CEP2yadHCNgmaUL1PD-8v9fm6x8/edit?tab=t.0#bookmark=kix.7akv47kpo2or){target=”_blank”}
...
That's the kind of question you can put in your one-document-to-rule, or even ask questions on the [muddy point Forum](https://generalpsychs-xkn6199.slack.com/archives/C06S2K2MGP7){target="_blank"}
...
[![Epistemology 8min](../images/Epistemology_better.png){width="40%"}](https://youtu.be/cIq2co5CXiA?si=DZ0OjDN7yBjncD4T "Epistemology"){target='_blank'}
...
9. [Watch video on writing guide](https://www.youtube.com/watch?v=ytWuC6tns_w&feature=youtu.be){target="_blank"}

10. Re-read the critical thinking items in the syllabus
    * Write them in your one document to rule them all and give a one-sentence description of each **using your own words.**

11. Read/skim [Chapter 2 of your textbook](https://openstax.org/books/psychology-2e/pages/2-introduction){target="_blank"}.  This means you should read the first page and the summary page of the chapter, and then skim the chapter for things relevant to your work or interests.  Take notes on what you find. You can put them into the google doc if you want.
...
1. Introduce yourself in  [#introductions](https://generalpsychs-xkn6199.slack.com/archives/C06RYTD2ZF0){target=”_blank”} 
...
7. Read some of your classmates' posts and comment on some.  
   
8. Read [This evaluation](https://docs.google.com/document/d/1-g6-uJELM5zgb-yTRCQ8Ah76P9FccFZ_V2GK6YwP3iw/edit?usp=sharing){target='_blank'}

9. Reminder to write down descriptions of the critical thinking standards in your own words.

10. Write a synthesis of the 4 sources above (1. the critical thinking standards, 2. stupidity in science, 3. red scare evaluation--the evaluation, not your thoughts, and then 4. chapter 2).  You may want to consider a comment about whether you think knowledge is static.
...
11. Put your writing into the 'one doc to rule them all'.  Give that page a new heading, a title. Highlight that title and go to the 'insert' menu item and insert "bookmark".  You should see a little blue ribbon and a "link" that you can copy and paste.

12. When you are done, post to the [#week-1](https://generalpsychs-xkn6199.slack.com/archives/C06S80U5T44){target="_blank"} channel by including a link to your document from step 2 above. 

```{block, Dangers of URLs1, type='blueBackground'}
...
5. ...share your ideas from # 3 above to the the [#week 2 channel---notice this is a clickable link](https://generalpsychs-xkn6199.slack.com/archives/C06T8A88N8K){target="_blank"}

```{block, Dangers of URLs2, type='blueBackground'}
Please note that slack has a bug that makes my URL links to channels automatically go to the #resource channel. That means you'll need to use the slack search bar at the top to find and join channels
```
...
5. Link your writing for  what you just wrote in #3 and #4 to channel [#week-3](https://generalpsychs-xkn6199.slack.com/archives/C06U82T3P7C){target='_blank'}.
...
```{block, Dangers of URLs3, type='blueBackground'}
Please note that slack has a bug that makes my URL links to channels automatically go to the #resource channel. That means you'll need to use the slack search bar at the top to find and join channels
```
...
2. Link your work to the [#week 4](https://generalpsychs-xkn6199.slack.com/archives/C06V9RHAXS8){target='_blank'} channel

```{block, Dangers of URLs4, type='blueBackground'}
Please note that slack has a bug that makes my URL links to channels automatically go to the #resource channel. That means you'll need to use the slack search bar at the top to find and join channels
```



# Week 5 April 29 {#Week6}
...
* skim this but pay closer attention to the semantic sections with the schematics for cars
...
4. Write down your solutions and post them, or at least the ones with which you feel comfortable sharing in the [#week 5 channel](https://generalpsychs-xkn6199.slack.com/archives/C070G5HC8G0){target='_blank'}

```{block, Dangers of URLs5, type='blueBackground'}
Please note that slack has a bug that makes my URL links to channels automatically go to the #resource channel. That means you'll need to use the slack search bar at the top to find and join channels
```



5. Once you have shared material to [#week 5](https://generalpsychs-xkn6199.slack.com/archives/C070G5HC8G0){target='_blank'}, Right click your post and notice the drop down menu that allows you "Reply in thread", and tag 3 people in our class by using the @ symbol and their name.  Ask them to take a look at your work and ask them for feedback on some part.  Maybe it's your writing--like word choice and/or clarity.  Maybe it's something about your critical thinking.  This is hard ask to make of others but try it anyway.  Also, because it's still the pandemic and everything is just hard, don't fret if people you invite can't respond. It's likely that they are just overwhelmed with something.
...
```
* Post your one-document again in the [#week6](https://generalpsychs-xkn6199.slack.com/archives/C071W0PG46R){target=”_blank”} channel...remember if the link takes you to resources, just used the slack search bar.
...
B. Post to the [#week 7](https://generalpsychs-xkn6199.slack.com/archives/C0732JJ0Q4T){target="_blank"} channel, invite 2 people to review your work by using the "@" symbol.  So, simply post your URL, and then reply to that post and ask a few people to take look at your work.
...
# Week 8 Personality May 20 {#Week8}
...
## Be sure to check out Week 11 Gun violence assignment on social psychology
...
* Post your work in the [#week-8](https://generalpsychs-xkn6199.slack.com/archives/C073U44EJ0N){target='_blank'} channel
...
## [Is Killmonger a villain or a tragic hero?](https://docs.google.com/document/d/1PQ4GopLAz2gnCf6RH3PjAdjAepYdgpMdUeIwEPNEkbY/edit?usp=sharing){target='_blank'}
...
* Share your writing with the  Channel [**#week9**](https://generalpsychs-xkn6199.slack.com/archives/C073L6ANN2K){target='_blank'}
...
## 1. [Assignments are here](https://docs.google.com/document/d/1oaC-Q_UNuxG16e3CSc-zRBfJzk9X92yjQPQ0f-PDoCw/edit?usp=sharing){target="_blank"}
   ...
   * The channel will be [#week-11](https://generalpsychs-xkn6199.slack.com/archives/C073L6C6K3R){target="_blank"}
...
## 3. All work should be completed by end of day, Wednesday June, 12 2024
