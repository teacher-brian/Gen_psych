...
3. Share your work on slack by linking to it in the slack channel [#week-2-synthesis](https://general-psychology-hq.slack.com/archives/C01T8UCJU4T){target='_blank'}
...
4. ...share your ideas from # 3 above to the Channel [#More_Biopsych](https://general-psychology-hq.slack.com/archives/C01U1TF04JY){target="_blank"} by pasting that link into Slack.
...
5. Link your writing for #3 and #4 to the Channel [#Learning-theory](https://general-psychology-hq.slack.com/archives/C01U8BFML9X){target="_blank"}
...
7. [Do A self-reflection Survey](https://forms.gle/v6FwuBw1gPtXfevQ8){target="_blank"}
...
2. Link your work to the [#multitasking channel](https://general-psychology-hq.slack.com/archives/C020GV34TPU){target="_blank"} 
...
3. Write down your solutions and post them, or at least the ones with which you feel comfortable sharing in the #[Dragon channel](https://general-psychology-hq.slack.com/archives/C020DSWNH61){target='_blank'}.
...
* Post your one-document again in the [#systems](https://general-psychology-hq.slack.com/archives/C021S7EHVLM){target='_blank'} channel.
...
A. [Complete the following assignment posted in a google doc](https://docs.google.com/document/d/1hCDt07L5NhMy0SQDW3k9g9O14YF0k0R-Gklzd7rTP4A/edit#){target="_blank"}
...
```{block,type='blueBackground'}
Please don't skip these videos.  Let me know if the links don't work for you. 
```
...
## Final Self Reflection Due by June 18

[Final Self-reflection](){target='_blank'} (this will be added soon)
