---
title: "General Psychology Schedule Fall 2022"
author: "Brian Holt"
date: "`r Sys.Date()`"
output: 
  html_document:
   ...
   config:
      toc:
        ...
        before: |
          <li><a href="./">General Psychology Fall 2022 schedule</a></li>
        after: |
...
That's the kind of question you can put in your one-document-to-rule, or even ask questions on the [muddy point channel](https://generalpsycho-seu2975.slack.com/archives/C043R4G24SX){target="_blank"}
...
3. On the same google document, make a new page, title it, and write some thoughts down to the following prompts.  
...
5. When you are done, post to the [#week-1](https://generalpsycho-seu2975.slack.com/archives/C043TLDKC20){target="_blank"} Slack channel by including a link to your document from step 2 above. 
...
6. Read some of your classmates' posts and comment on some.  
>>>>>>> 3597693fb5b015f8785764357cd18910c80f72f9

6. Read some of your classmates' posts and comment on some.  

## In class Conversation Questions

These are questions that I'd like to discuss during Zoom sessions.  I think that if you've done the reading/watching of videos, you may have the ability to contribute to the conversation.
...
3. Share your work on slack by linking to it in the slack channel #week-2-synthesis.
...
4. ...share your ideas from # 3 above to the Channel #More_Biopsych by pasting that link into Slack.
...
5. Link your writing for #3 and #4 to the Channel #Learning-theory.  Search for it in the Slack Search Bar.
...
2. Go to Wikipedia and look up "list of cognitive biases".  Use the full phrase.

3. Pick 3 of your favorite biases from that wikipedia list and describe them in your own words; include a link to them along with a proper reference.  I don't have a preference for which referencing style.  Post your work to the #Biases channel.
...
On Wednesday, Nov 2, there will be no classes held for the whole school.  

Faculty are expected to be doing other college work.  

Which means none of you can be required to attend any class on 11/2.  For any class.  In the whole Seattle college district.  
```
...
3. Write down your solutions and post them, or at least the ones with which you feel comfortable sharing in the #[Dragon channel](https://generalpsycho-seu2975.slack.com/archives/C0486E7DU79){target='_blank'}.
...
1. This one is recent, shorter, and from our class.  The document and video can be found in this [#resource channel post](https://generalpsycho-seu2975.slack.com/archives/C043DFTE7QA/p1664314061468869){target='_blank'}
...
* Post your one-document again in the [#systems](https://generalpsycho-seu2975.slack.com/archives/C049AMSKYG0){target='_blank'} channel. 
...
B. Post to [**#metacognition**](https://generalpsycho-seu2975.slack.com/archives/C049LNNR4E7){target="_blank"} channel, tag 2 people to review your work.  
...
* Post your work in the [#threads](https://generalpsycho-seu2975.slack.com/archives/C04B380S77V){target='_blank'} channel
...
Post to your optional work to  #[killmonger](https://generalpsycho-seu2975.slack.com/archives/C04B5SGVD7E){target='_blank'}
...
* Share your writing with the slack Channel [**#abnormal**](https://generalpsycho-seu2975.slack.com/archives/C04B384F4R1){target='_blank'} 
...
## 1. [Assignments are here](https://docs.google.com/document/d/1oaC-Q_UNuxG16e3CSc-zRBfJzk9X92yjQPQ0f-PDoCw/edit?usp=sharing){target="_blank"}
   ...
   * The channel will be [#social-psych](https://generalpsycho-seu2975.slack.com/archives/C04ANQS9UQP){target="_blank"}

## 2. [Final Self-reflection](https://forms.gle/VhfLKCBMugfDJuy18){target="_blank"}

## 3. [All work should be completed by end of day, December 12, 2022](https://northseattle.edu/calendars/academic-calendar){target="_blank"}
