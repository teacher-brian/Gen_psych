---
title: "General Psychology Schedule Winter 2022"
author: "Brian Holt"
date: "`r Sys.Date()`"
output: 
  html_document:
   ...
   config:
      toc:
        ...
        before: |
          <li><a href="./">General Psychology Winter 2022 schedule</a></li>
        after: |
...
1. Introduce yourself in the Slack [Introductions](https://slack-wh52985.slack.com/archives/C02SJRKEBA7){target='_blank'} channel
...
2. Write something about what interests you about psychology in your one google doc..remember, have one document. Be sure to give it a title.  Write about things that interest you and ponder whether psychology is related.  

3. On the same google document, make a new page, title it, and write some thoughts down to the following prompts.  When you are done, post to the [week_1 slack channel](https://slack-wh52985.slack.com/archives/C02SJRKEBA7){target=”_blank”} by including a link to your document from step 2 above.
...
## Thursday Conversation Questions

These are questions that I'd like to discuss on Thursday Zoom sessions.  I think that if you've done the reading/watching of videos, you may have the ability to contribute to the conversation.
...
2. Put your writing into the 'one doc to rule them all'.  Give that page a new heading, a title. Highlight that title and go to the 'insert' menu item and 7insert "bookmark".  You should see a little blue ribbon and a "link" that you can copy and paste into slack...

3. Share your work on slack by linking to it in the slack channel [#week-2-synthesis](https://generalpsycho-8vc5576.slack.com/archives/C02SGF1MQMB){target='_blank'}
...
F. Read Nancy Chick, [Metacognition](https://cft.vanderbilt.edu/guides-sub-pages/metacognition/){target="_blank"}

G. Read  Alfie Kohn, [The Case Against Grades](https://www.alfiekohn.org/article/case-grades/){target="_blank"}
...
4. ...share your ideas from # 3 above to the Channel [#More_Biopsych](https://generalpsycho-8vc5576.slack.com/archives/C02SKD5RT7V){target="_blank"} by pasting that link into Slack.
5. Read some other posts from classmates and comment about some areas of interest.
6. [Do A self-reflection Survey](https://docs.google.com/forms/d/e/1FAIpQLSdCKXCNvH-nSdnuCz0OrFUcQPZXVEugR4D5lyBiZzNKYVkANw/viewform?usp=sf_link){target="_blank"}
