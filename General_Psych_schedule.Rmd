...
[Slack tips, will need to sing in to canvas for this video](https://northseattle.hosted.panopto.com/Panopto/Pages/Viewer.aspx?id=ba5dc535-de92-40c7-9460-ac5301350a62){target='_blank'}

##### Canvas will be used lightly.  First week discussions and introductions, a place to find this schedule, and a way for me to quickly send announcements. 
...
A. Like last week, Pick a behavior--a feeling, an action, a thought, but try to keep it simple (thoughts may work here) and write a few sentences that explains how the environment causes the behavior. Said another way, explain what is happening in the enviornment to elicit the behavior.  For clarification, you could say last week the biology is **how** the behavior works while this week you are explaining **when** it works. **Do this before watching/reading below**
...
1. Reassess your understanding from above A.
2. Is your chosen behavior better expalined by classical conditioning or operant conditioning?  What key feature led you to this choice?
3. Whether or not the textbook and videos didn't lead to any new learning, identify what you would like to know more about.  What is still missing for you?
4. Choose a new behavior that you want to change its frequency.  Like eating more chocolate.  I mean less.  Less chocolate.  How migth you change the **enviorment** so that you eat ~~more, damn~~ I mean less chocolate?
...
A. Read [Chapter 8 of your textbook](https://openstax.org/books/psychology-2e/pages/8-introduction){target="_blank"}
