---
title: "General Psychology Schedule Spring 2024"
author: "Brian Holt"
date: "`r Sys.Date()`"
output: 
  html_document:
   ...
   config:
      toc:
        ...
        before: |
          <li><a href="./">General Psychology Spring 2024 schedule</a></li>`
        after: |
...
12. Read @Schwartz1771, [The importance of stupidity in scientific research](https://jcs.biologists.org/content/121/11/1771){target='_blank'}
...
<!-- 5. Link your writing for  what you just wrote in #3 and #4 to channel [#week-4](https://24generalnorthseattle.slack.com/archives/C06EPMWR26A){target='_blank'}. -->
...
<!-- 2. Link your work to the [#week 5](https://24generalnorthseattle.slack.com/archives/C06F90LR9ND){target='_blank'} channel -->

<!-- # Week 6 Feb 5 {#Week6}  -->

<!-- ```{block, type='instructorNote'} -->
<!-- On Thursday, Feb 8, there will be no classes held for the whole college district.   -->

<!-- Faculty are expected to be doing other college work.  It's like a teacher's workshop day. -->

<!-- Which means none of you can be required to attend any class on 2/8.  For any class in the whole Seattle college district.   -->
<!-- ``` -->
...
<!-- 4. Write down your solutions and post them, or at least the ones with which you feel comfortable sharing in the [#week 6 channel](https://24generalnorthseattle.slack.com/archives/C06GXH9H0S2){target='_blank'} -->

<!-- 5. Once you have shared material to [#week-6](https://24generalnorthseattle.slack.com/archives/C06GXH9H0S2){target='_blank'}, Right click your post and notice the drop down menu that allows you "Reply in thread", and tag 3 people in our class by using the @ symbol and their name.  Ask them to take a look at your work and ask them for feedback on some part.  Maybe it's your writing--like word choice and/or clarity.  Maybe it's something about your critical thinking.  This is hard ask to make of others but try it anyway.  Also, because it's still the pandemic and everything is just hard, don't fret if people you invite can't respond. It's likely that they are just overwhelmed with something. -->
...
<!-- ``` -->
<!-- * Post your one-document again in the [#week7](https://24generalnorthseattle.slack.com/archives/C06H18Y6LE9){target=”_blank”} channel.  -->
...
<!-- B. Post to the [#week8](https://24generalnorthseattle.slack.com/archives/C06KE102RT4){target="_blank"} channel, invite 2 people to review your work by using the "@" symbol.  So, simply post your URL, and then reply to that post and ask a few people to take look at your work.  -->
...
<!-- # Week 9 Personality Feb 26 20 {#Week9} -->
...
<!-- * Post your work in the [#week-9](https://24generalnorthseattle.slack.com/archives/C06LF0CPCA1){target='_blank'} channel -->
...
<!-- # Week 10 Abnormal March 4 {#Week10} -->
...
<!-- * Share your writing with the  Channel [**#week-10**](https://24generalnorthseattle.slack.com/archives/C06LB8K0TAS){target='_blank'}  -->

<!-- * Comment on 2 or 3 of your classmates work. -->


<!-- # Week 11 (March 11) {#Week11} -->
...
<!--    * The channel will be [#week-11](https://24generalnorthseattle.slack.com/archives/C06LHQ5M39R){target="_blank"} -->

<!-- ## 2. [Final Self-reflection](https://forms.gle/VhfLKCBMugfDJuy18){target="_blank"} -->

<!-- ## 3. All work should be completed by end of day, Sunday March 17, 2024. -->
