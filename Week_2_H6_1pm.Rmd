...
2. Put your writing into the 'one doc to rule them all'.  Give that page a new heading, a title. Highlight that title and go to the 'insert' menu item and insert "bookmark".  You should see a little blue ribbon and a "link" that you can copy and paste into canvas...

3. Share your work on canvas by linking to it in the canvas Discussion #[week-2 completed work](https://canvas.seattlecolleges.edu/courses/16707/discussion_topics/156341?module_item_id=740396){target='_blank'}.
